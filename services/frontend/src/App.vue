<template>
  <div id="app">
    ...
    <!-- <div v-show="pdfpath != undefined" class="mx-auto mt-20 mb-5 w-full">
      <div
        class="pdfviewer-container border border-black w-9/12 inline-block mx-auto"
      >
        <PDFViewer :pdfpath="pdfpath"></PDFViewer>
      </div>
      <div
        class="ocrtext-container border border-black w-9/12 inline-block mx-auto"
      >
        <PDFViewer :pdfpath="pdfpath"></PDFViewer>
      </div>
    </div> -->
